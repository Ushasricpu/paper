            ...
            filtered = Object.fromEntries(
                Object.entries(filtered).map(([bus_no, data]) => [
                    ...
                    data.filter(item => {
                        ...
                        const isAfterStartDate = startDate ? moment(startDate, 'DD-MM-YYYY').isSameOrBefore(itemDate, 'day') : true;
                        const isBeforeEndDate = endDate ? moment(endDate, 'DD-MM-YYYY').isSameOrAfter(itemDate, 'day') : true;
